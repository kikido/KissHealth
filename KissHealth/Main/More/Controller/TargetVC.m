...
- (void)tableviewHiddenOpen
{
    ...
    [weekAlert addAction:[UIAlertAction actionWithTitle:@"否" style:UIAlertActionStyleDefault handler:NULL]];
    ...
    [activityAlert addAction:[UIAlertAction actionWithTitle:@"否" style:UIAlertActionStyleDefault handler:NULL]];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (tableView.tag == 213) {
        ...
        if (tableView.tag == 214) {
            ...
            [_subTitleArray replaceObjectAtIndex:2 withObject:[_weekArray objectAtIndex:indexPath.row]];
            
        }else if (tableView.tag == 215){
        
            [_subTitleArray replaceObjectAtIndex:3 withObject:[_activityArray objectAtIndex:indexPath.row]];
        }
    }
}
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    if (pickerView.tag == 1100) {
        ...
        NSString *str = _exercisePkViewArray[row];
        [_subTitleArray replaceObjectAtIndex:4 withObject:str];
    }
    if (pickerView.tag == 1101) {
        
        NSString *str1 = _minutesPkViewArray[row];
        [_subTitleArray replaceObjectAtIndex:5 withObject:str1];
    }
}
@end
