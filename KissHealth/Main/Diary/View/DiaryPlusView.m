...
- (void)_createPickerView
{
    ...
    UIButton *closeButton = [[UIButton alloc] initWithFrame:CGRectMake(10, 5, 30, 30)];
    ...
    UIButton *checkButton = [[UIButton alloc] initWithFrame:CGRectMake(kScreenWidth - 35, 5, 30, 30)];
