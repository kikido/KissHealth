...
- (void)_createExciseView
{
    ...
    int x = kScreenWidth - 65;
    
    UITextField *timeTF = [[UITextField alloc] initWithFrame:CGRectMake(x, 0, 55, 50)];
    ...
    _kaloriNumberLabel = [[UILabel alloc] initWithFrame:CGRectMake(x, 51, 55, 50)];
